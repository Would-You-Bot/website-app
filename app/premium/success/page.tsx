...
export default function Premium() {
  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-8 px-8 text-neutral-300">
        <h1 className="mt-36 text-4xl font-bold text-brand-blue-100 text-center drop-shadow-blue-glow">
          Payment Successful!
        </h1>
        <p className="mb-4 text-lg text-white">
          Your payment for Would You Premium billed <b>{type === "monthly" ? "monthly" : "annually"}</b> was successful!
        </p>
        // TODO: Add space between the premium text
        <Button className="justify-center" onClick={() => window.open(`https://discord.com/channels/${serverId}/`, "_blank")}>Click to visit your new <b>Premium</b> server</Button>
      </main>
    </>
  );
}
